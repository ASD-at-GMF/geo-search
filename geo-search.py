    ...
    try:
        for row in reader:
            ...
            try:
                ...
                requests.get('https://hc-ping.com/17508cb1-2b7d-49e9-b837-b6bede84ce22/fail')
                #requests.post('https://hc-ping.com/17508cb1-2b7d-49e9-b837-b6bede84ce22/log', json = {'error':e, 'query': row['query'], 'location':row['location'], 'engine': row['engine']})
                traceback.print_exc()
                print(e)
                continue
    finally:
